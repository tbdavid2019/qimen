...
app.get('/api/skills', (req, res) => {
    res.json({
        success: true,
        hub: "https://github.com/tbdavid2019/qimen/tree/main/skills",
        readme: "https://github.com/tbdavid2019/qimen#readme",
        protocols: {
            webmcp: "Chrome In-Browser WebMCP Standard (document.modelContext)",
            mcpBridge: "JSON-RPC 2.0 stdio (mcp-bridge.js)",
            restApi: "POST /api/*-question"
        },
        skills: [
            {
                name: "qimen-consultant",
                title: "奇門遁甲 Consultant",
                description: "十天干克應格局庫、三遁吉格、專題用神與主客動靜利弊分析",
                path: "skills/qimen-consultant/SKILL.md",
                script: "skills/qimen-consultant/scripts/ask_qimen.js",
                endpoint: "POST /api/qimen-question",
                github: "https://github.com/tbdavid2019/qimen/tree/main/skills/qimen-consultant"
            },
            {
                name: "meihua-consultant",
                title: "梅花易數 Consultant",
                description: "本互變錯綜五卦全息盤面、時間/數字/漢字起卦與 384 爻辭應期",
                path: "skills/meihua-consultant/SKILL.md",
                script: "skills/meihua-consultant/scripts/ask_meihua.js",
                endpoint: "POST /api/meihua-question",
                github: "https://github.com/tbdavid2019/qimen/tree/main/skills/meihua-consultant"
            },
            {
                name: "bazi2-consultant",
                title: "生辰八字 Consultant",
                description: "子平四柱排盤、十神藏干、納音長生、旺衰得分、格局喜忌與九大神煞",
                path: "skills/bazi2-consultant/SKILL.md",
                script: "skills/bazi2-consultant/scripts/ask_bazi2.js",
                endpoint: "POST /api/bazi2-question",
                github: "https://github.com/tbdavid2019/qimen/tree/main/skills/bazi2-consultant"
            },
            {
                name: "yinyuan-consultant",
                title: "月老姻緣 Consultant",
                description: "100 支月老靈籤、生肖配對、紫微夫妻宮、桃花運勢、八字合婚與紅線測算",
                path: "skills/yinyuan-consultant/SKILL.md",
                script: "skills/yinyuan-consultant/scripts/ask_yinyuan.js",
                endpoint: "POST /api/yinyuan-question",
                github: "https://github.com/tbdavid2019/qimen/tree/main/skills/yinyuan-consultant"
            },
            {
                name: "fengshui-consultant",
                title: "易經風水 Consultant",
                description: "玄空飛星 24 山 9 運、八宅明鏡、8 大內外形煞化解與協紀辨方擇日",
                path: "skills/fengshui-consultant/SKILL.md",
                script: "skills/fengshui-consultant/scripts/ask_fengshui.js",
                endpoint: "POST /api/fengshui-question",
                github: "https://github.com/tbdavid2019/qimen/tree/main/skills/fengshui-consultant"
            },
            {
                name: "tarot-consultant",
                title: "韋特塔羅 Consultant",
                description: "78 張韋特牌庫、6 大牌陣、四維透鏡、元素相生相剋與行動指引",
                path: "skills/tarot-consultant/SKILL.md",
                script: "skills/tarot-consultant/scripts/ask_tarot.js",
                endpoint: "POST /api/tarot-question",
                github: "https://github.com/tbdavid2019/qimen/tree/main/skills/tarot-consultant"
            },
            {
                name: "answerbook-consultant",
                title: "解答之書 Consultant",
                description: "直接默念隨機翻頁與問題 AI 深度象徵解讀",
                path: "skills/answerbook-consultant/SKILL.md",
                script: "skills/answerbook-consultant/scripts/ask_answerbook.js",
                endpoint: "POST /api/answerbook-question",
                github: "https://github.com/tbdavid2019/qimen/tree/main/skills/answerbook-consultant"
            }
        ]
    });
});
