...
`;
    ...
    async analyzeQimen(qimenData, options = {}) {
        ...
        try {
            ...
            const analysisText = (response && response.content) ? response.content : '';
            const isTruncated = response && response.finishReason === 'length';
            ...
            return {
                ...
                model: this.model,
                finishReason: response ? response.finishReason : null,
