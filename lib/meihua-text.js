...
const YAOCI_PATH = path.join(__dirname, '..', 'data', 'meihua', 'yaoci.md');
...
function getYaociRaw() {
    if (yaociRawCache) {
        return yaociRawCache;
    }
    yaociRawCache = fs.readFileSync(YAOCI_PATH, 'utf8');
    return yaociRawCache;
}
