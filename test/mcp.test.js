...
test('MCP source 包含新增服務工具與完整欄位', () => {
    ...
    for (const toolName of ['tarot_divination', 'fengshui_consultation', 'bazi2_analysis', 'yinyuan_reading', 'answerbook_reading']) {
...
test('零依賴 MCP bridge 也包含七個服務工具', () => {
    const bridge = fs.readFileSync(bridgePath, 'utf8');
    for (const toolName of ['qimen_divination', 'meihua_divination', 'tarot_divination', 'fengshui_consultation', 'bazi2_analysis', 'yinyuan_reading', 'answerbook_reading']) {
